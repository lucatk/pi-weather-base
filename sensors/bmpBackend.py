...
class BMP180:
    ...
    def readCalibrationData(self):
        ...
        self._cal_AC1 = self.i2c.readS16(self.__BMP180_CAL_AC1)   # INT16
        self._cal_AC2 = self.i2c.readS16(self.__BMP180_CAL_AC2)   # INT16
        self._cal_AC3 = self.i2c.readS16(self.__BMP180_CAL_AC3)   # INT16
        self._cal_AC4 = self.i2c.readU16(self.__BMP180_CAL_AC4)   # UINT16
        self._cal_AC5 = self.i2c.readU16(self.__BMP180_CAL_AC5)   # UINT16
        self._cal_AC6 = self.i2c.readU16(self.__BMP180_CAL_AC6)   # UINT16
        self._cal_B1 = self.i2c.readS16(self.__BMP180_CAL_B1)     # INT16
        self._cal_B2 = self.i2c.readS16(self.__BMP180_CAL_B2)     # INT16
        self._cal_MB = self.i2c.readS16(self.__BMP180_CAL_MB)     # INT16
        self._cal_MC = self.i2c.readS16(self.__BMP180_CAL_MC)     # INT16
        self._cal_MD = self.i2c.readS16(self.__BMP180_CAL_MD)     # INT16
        if (self.debug):
    ...
    def readRawTemp(self):
        ...
        self.i2c.write8(self.__BMP180_CONTROL, self.__BMP180_READTEMPCMD)
        time.sleep(0.005)  # Wait 5ms
        raw = self.i2c.readU16(self.__BMP180_TEMPDATA)
        if (self.debug):
    ...
    def readRawPressure(self):
        ...
        self.i2c.write8(self.__BMP180_CONTROL, self.__BMP180_READPRESSURECMD + (self.mode << 6))
        if (self.mode == self.__BMP180_ULTRALOWPOWER):
            ...
            time.sleep(0.008)
        msb = self.i2c.readU8(self.__BMP180_PRESSUREDATA)
        lsb = self.i2c.readU8(self.__BMP180_PRESSUREDATA+1)
        xlsb = self.i2c.readU8(self.__BMP180_PRESSUREDATA+2)
    ...
    def readPressure(self):
        ...
        if (dsValues):
            ...
            self._cal_AC1 = 408
            self._cal_AC4 = 32741
            self.mode = self.__BMP180_ULTRALOWPOWER
            if (self.debug):
                self.showCalibrationData()
